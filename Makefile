...
compile:
	g++ -std=c++17 -w server.cpp server_controller.cpp UI/blackjack/message.cpp accountmanager.cpp md5.cpp clientmanager.cpp state.cpp -o server -lcrypto -lssl -ljsoncpp
